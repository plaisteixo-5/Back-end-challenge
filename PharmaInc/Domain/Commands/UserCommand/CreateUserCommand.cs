...
namespace Domain.Commands
{
    public class CreateUserCommand : Notifiable, ICommand
    {
        ...
        public CreateUserCommand(string gender, Name name, Location location, string email, Login login, Dob dob, Registered registered, string phone, string cell, Id id, Picture picture, string nat)
        {
            Gender = gender;
            Name = name;
            Location = location;
